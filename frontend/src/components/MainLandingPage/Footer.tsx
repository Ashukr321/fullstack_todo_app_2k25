...
const Footer = () => {
  return (
    <footer className="w-full relative bg-[#18181b] overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center md:justify-between gap-4 relative z-10">
        <div className="text-gray-400 text-center md:text-left text-sm order-2 md:order-1">
          &copy; {new Date().getFullYear()} TaskSprint. All rights reserved.
        </div>
